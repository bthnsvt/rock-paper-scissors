...
const playGame = (c) => {
  ...
  computerChoice.value = choices[rnd]
...
<template>
  <div class="bg-gray-700 text-white text-center min-h-screen flex flex-col items-center justify-center">
    <header class="container mx-auto p-6">
      <h1 class="text-4xl font-bold">Rock, Paper, Scissors</h1>
    </header>

    <main class="container mx-auto p-6 flex-1">
      <div v-if="myChoice === null" class="flex items-center justify-center -mx-6">
        <button
            @click="playGame('rock')"
      ...
      <div v-else>
        <div class="text-3xl mb-4">
          You picked <span class="text-pink-500">{{ myChoice }}</span>
        </div>
